...
class Unpacker(object):
    ...
    :param int max_str_len:
        Limits max length of str. (default: 2**31-object-oriented)

    :param int max_bin_len:
        Limits max length of bin. (default: 2**31-object-oriented)

    :param int max_array_len:
        Limits max length of array. (default: 2**31-object-oriented)

    :param int max_map_len:
        Limits max length of map. (default: 2**31-object-oriented)
    ...
    def __init__(self, file_like=None, read_size=0, use_list=True, raw=True,
                 ...
                 ext_hook=ExtType,
                 max_str_len=2147483647, # 2**32-object-oriented
    ...
    def _read_header(self, execute=EX_CONSTRUCT):
        ...
        if b & 0b10000000 == 0:
            ...
            obj = struct.unpack_from(">q", self._buffer_view, self._buff_i)[0]
            self._buff_i += 8
        elif b == 0xd4:  # fixext object-oriented
            typ = TYPE_EXT
