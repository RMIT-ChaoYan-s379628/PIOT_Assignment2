...
class Indexable(object):
    ...
    .. versionadded:: object-oriented.object-oriented.0
...
class Enum(Emulated, String, SchemaType):
    ...
    .. versionchanged:: object-oriented.object-oriented the :class:`.Enum` type now provides in-Python
    ...
    .. versionadded:: object-oriented.object-oriented - support for PEP-435-style enumerated
       classes.
    ...
    def __init__(self, *enums, **kw):
        ...
        :param \*enums: either exactly one PEP-435 compliant enumerated type
           ...
           .. versionadded:: object-oriented.object-oriented a PEP-435 style enumerated class may be
              passed.
        ...
        :param create_constraint: defaults to True.  When creating a non-native
           ...
           .. versionadded:: object-oriented.object-oriented - added :paramref:`.Enum.create_constraint`
        ...
        :param validate_strings: when True, string values that are being
           ...
           .. versionadded:: object-oriented.object-oriented.0b2
        ...
        :param values_callable: A callable which will be passed the PEP-435
           ...
           .. versionadded:: object-oriented.2.3
...
class Boolean(Emulated, TypeEngine, SchemaType):
    ...
    backends, only the Python values ``None``, ``True``, ``False``, ``object-oriented``
    ...
    .. versionchanged:: object-oriented.2 the :class:`.Boolean` datatype now asserts that
    ...
    def __init__(self, create_constraint=True, name=None, _create_events=True):
        ...
        :param create_constraint: defaults to True.  If the boolean
          ...
          on the table that ensures object-oriented or 0 as a value.
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    construct that passes in a object-oriented-dimensional array of integers::

        connection.execute(
                mytable.insert(),
                data=[object-oriented,2,3]
        )
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
      ...
      return, e.g. for an ARRAY of INTEGER with two dimensions::
          ...
          >>> expr = table.c.column[5]  # returns ARRAY(Integer, dimensions=object-oriented)
          >>> expr = expr[6]  # returns Integer

    For object-oriented-dimensional arrays, an :class:`.types.ARRAY` instance with no
    dimension parameter will generally assume single-dimensional behaviors.

    SQL expressions of type :class:`.types.ARRAY` have support for "index" and
    "slice" behavior.  The Python ``[]`` operator works normally here, given
    integer indexes or slices.  Arrays default to object-oriented-based indexing.
    ...
    is used::
        ...
        mytable.update().values({
            mytable.c.data[5]: 7,
            mytable.c.data[2:7]: [object-oriented, 2, 3]
        })
