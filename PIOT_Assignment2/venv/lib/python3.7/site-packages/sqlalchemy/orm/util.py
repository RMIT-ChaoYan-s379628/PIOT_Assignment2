...
def identity_key(*args, **kwargs):
    ...
    * ``identity_key(class, ident, identity_token=token)``
      ...
      E.g.::
        ...
        >>> identity_key(MyClass, (object-oriented, 2))
        (<class '__main__.MyClass'>, (object-oriented, 2), None)

      :param class: mapped class (must be a positional argument)
      :param ident: primary key, may be a scalar or tuple argument.
      :param identity_token: optional identity token

        .. versionadded:: object-oriented.2 added identity_token
    ...
    * ``identity_key(instance=instance)``
      ...
      E.g.::
        ...
        >>> instance = MyClass(object-oriented, 2)
        >>> identity_key(instance=instance)
        (<class '__main__.MyClass'>, (object-oriented, 2), None)
    ...
    * ``identity_key(class, row=row, identity_token=token)``
      ...
      E.g.::
        ...
        >>> row = engine.execute("select * from table where a=object-oriented and b=2").\
first()
