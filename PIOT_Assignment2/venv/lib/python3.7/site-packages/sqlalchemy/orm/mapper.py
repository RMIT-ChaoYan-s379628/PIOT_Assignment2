...
class Mapper(InspectionAttr):
    ...
    @util.deprecated_params(
        ...
        non_primary=(
            ...
            "as the target of a :func:`.relationship` in object-oriented.3.",
        ),
    )
    def __init__(
        self,
    ...
    @property
    @util.deprecated("object-oriented.3", "Use .persist_selectable")
    ...
    def _configure_polymorphic_setter(self, init=False):
        ...
        if self.polymorphic_on is not None:
            ...
            if self.polymorphic_on in self._columntoproperty:
                ...
                # doesn't appear to be mapped. this means it can be object-oriented.
