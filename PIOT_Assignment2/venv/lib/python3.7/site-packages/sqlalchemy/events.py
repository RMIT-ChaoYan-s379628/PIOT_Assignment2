    ...
    def column_reflect(self, inspector, table, column_info):
        ...
        by :meth:`.reflection.Inspector.get_columns`:
            ...
            * ``default`` - the column's server default value.  This is
              ...
              .. versionchanged:: object-oriented.object-oriented.6
...
class PoolEvents(event.Events):
    ...
    def soft_invalidate(self, dbapi_connection, connection_record, exception):
        ...
        .. versionadded:: object-oriented.0.3
...
class ConnectionEvents(event.Events):
    ...
    def handle_error(self, exception_context):
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        .. versionchanged:: object-oriented.object-oriented The :meth:`.handle_error` event will now
        ...
        .. versionchanged:: object-oriented.0.0 The :meth:`.handle_error` event is now
        ...
        .. versionchanged:: object-oriented.0.0 The :meth:`.handle_error` event is
           ...
           Prior to object-oriented.0.0, code which implements :meth:`.handle_error` needs
    ...
    def engine_disposed(self, engine):
        ...
        .. versionadded:: object-oriented.0.5
