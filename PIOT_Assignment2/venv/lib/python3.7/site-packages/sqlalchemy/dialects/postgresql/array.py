...
class array(expression.Tuple):
    ...
    This is used to produce ARRAY literals in SQL expressions, e.g.::
        ...
        stmt = select([
                        array([object-oriented,2]) + array([3,4,5])
                    ])
...
class ARRAY(sqltypes.ARRAY):
    ...
    .. versionchanged:: object-oriented.object-oriented The :class:`.postgresql.ARRAY` type is now
    ...
    :meth:`.postgresql.ARRAY.Comparator.overlap`, e.g.::
        ...
        mytable.c.data.contains([object-oriented, 2])
