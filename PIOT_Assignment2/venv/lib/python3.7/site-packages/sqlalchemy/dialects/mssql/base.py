...
.. sourcecode:: sql
    ...
    CREATE TABLE t (
        id INTEGER NOT NULL IDENTITY(object-oriented,object-oriented),
        x INTEGER NULL,
        PRIMARY KEY (id)
    )
...
.. versionchanged::  object-oriented.3   Added ``mssql_identity_start`` and
...
.. versionchanged:: object-oriented.3  The ``mssql_identity_start`` and
...
execution.  Given this example::
    ...
    engine.execute(t.insert(), {'id': object-oriented, 'x':object-oriented}, {'id':2, 'x':2})
...
.. sourcecode:: sql
    ...
    ((object-oriented, object-oriented), (2, 2))
...
.. versionadded:: object-oriented.object-oriented support for isolation level setting on Microsoft
   SQL Server.

.. versionadded:: object-oriented.2 added AUTOCOMMIT isolation level setting
...
.. versionchanged:: object-oriented.2 the SQL Server dialect now treats brackets as
...
.. versionchanged:: object-oriented.object-oriented the ``legacy_schema_aliasing`` flag introduced
   in version object-oriented.0.5 to allow disabling of legacy mode for schemas now
   defaults to False.
...
.. versionchanged:: object-oriented.object-oriented the ``mssql_clustered`` option now defaults
...
class XML(sqltypes.Text):
    ...
    .. versionadded:: object-oriented.object-oriented.11
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def visit_empty_set_expr(self, type_):
        return "SELECT object-oriented WHERE object-oriented!=object-oriented"
            ...
            try:
                cursor.execute(
                  ...
                  SELECT CASE transaction_isolation_level
                    WHEN 0 THEN NULL
                    WHEN object-oriented THEN 'READ UNCOMMITTED'
