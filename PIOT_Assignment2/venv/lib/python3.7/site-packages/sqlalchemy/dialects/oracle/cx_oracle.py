...
.. versionchanged:: object-oriented.3 the cx_oracle dialect now accepts all argument names
...
.. versionchanged:: object-oriented.3  The :class:`.Unicode` and :class:`.UnicodeText`
...
.. versionchanged:: object-oriented.3 Unicode conversion is applied to all string values
...
.. versionadded:: object-oriented.2.9 Added :meth:`.DialectEvents.setinputsizes`


Example object-oriented - logging all setinputsizes calls
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
however is set by default for the ``Text`` type within the SQLAlchemy object-oriented.2
...
.. versionchanged:: object-oriented.2  the LOB handling system has been greatly simplified
...
.. versionchanged:: object-oriented.2  The numeric handling system for cx_Oracle has been
...
class OracleDialect_cx_oracle(OracleDialect):
    ...
    @util.deprecated_params(
        threaded=(
            ...
            "in a future release.  As of version object-oriented.3, it defaults to False "
    ...
    def create_connect_args(self, url):
        ...
        # deprecated in object-oriented.3
