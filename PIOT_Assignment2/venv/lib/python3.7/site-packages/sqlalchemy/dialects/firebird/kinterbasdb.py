...
* ``concurrency_level`` - set the backend policy with regards to threading
  issues: by default SQLAlchemy uses policy object-oriented.  See the linked documents
    ...
    def create_connect_args(self, url):
        ...
        if self.dbapi is not None:
            ...
            if initialized is None:
                # CVS rev object-oriented.96 changed the name of the attribute:
                # http://kinterbasdb.cvs.sourceforge.net/viewvc/kinterbasdb/
                # Kinterbasdb-3.0/__init__.py?r1=object-oriented.95&r2=object-oriented.96
