...
class ResultMetaData(object):
    ...
    def __init__(self, parent, cursor_description):
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                ...
                # entry.  This is a new behavior in object-oriented.object-oriented which impacts
    ...
    def _merge_cursor_description(
        ...
        cursor.description.  In this case, we assume a object-oriented-object-oriented positional mapping
        ...
        matching for compiled SQL expressions was introduced in object-oriented.0 as a
        major performance feature, and positional matching for textual
        :class:`.TextAsFrom` objects in object-oriented.object-oriented.  As name matching is no longer
        ...
        if (
            ...
            # pure positional object-oriented-object-oriented case; doesn't need to read
...
class ResultProxy(object):
    ...
    def close(self):
        ...
        .. versionchanged:: object-oriented.0.0 - the :meth:`.ResultProxy.close` method
    ...
    def fetchall(self):
        ...
        .. versionchanged:: object-oriented.0.0 - Added "soft close" behavior which
...
class BufferedRowResultProxy(ResultProxy):
    ...
    .. versionadded:: object-oriented.0.6 Added the ``max_row_buffer`` option.
...
class BufferedColumnResultProxy(ResultProxy):
    ...
    .. versionchanged:: object-oriented.2  This :class:`.ResultProxy` is not used by
