...
def create_engine(*args, **kwargs):
    ...
    :param empty_in_strategy:  The SQL compilation strategy to use when
        ...
        will generate a simple false expression "object-oriented != object-oriented".   The ``dynamic``
        strategy behaves like that of SQLAlchemy object-oriented.object-oriented and earlier, emitting
        ...
        .. versionadded:: object-oriented.2  Added the ``empty_in_strategy`` setting and
    ...
    :param pool_recycle=-object-oriented: this setting causes the pool to recycle
        connections after the given number of seconds has passed. It
        defaults to -object-oriented, or no timeout. For example, setting to 3600
