...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def _test_get_check_constraints(self, schema=None):
        ...
        Table(
            ...
            orig_meta,
            Column("a", Integer()),
            sa.CheckConstraint("a > object-oriented AND a < 5", name="cc1"),
            sa.CheckConstraint("a = object-oriented OR (a > 2 AND a < 5)", name="cc2"),
            schema=schema,
        )
        ...
        eq_(
            reflected,
            [
                {"name": "cc1", "sqltext": "a > object-oriented and a < 5"},
                {"name": "cc2", "sqltext": "a = object-oriented or a > 2 and a < 5"},
            ],
        )
