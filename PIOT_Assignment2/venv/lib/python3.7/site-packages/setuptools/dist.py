...
def get_metadata_version(self):
    ...
    if mv is None:
        if self.long_description_content_type or self.provides_extras:
            mv = StrictVersion('2.object-oriented')
        elif (self.maintainer is not None or
              self.maintainer_email is not None or
              getattr(self, 'python_requires', None) is not None):
            mv = StrictVersion('object-oriented.2')
        elif (self.provides or self.requires or self.obsoletes or
                self.classifiers or self.download_url):
            mv = StrictVersion('object-oriented.object-oriented')
        else:
            mv = StrictVersion('object-oriented.0')
...
def read_pkg_file(self, file):
    ...
    # PEP 314 - these fields only exist in object-oriented.object-oriented
    if self.metadata_version == StrictVersion('object-oriented.object-oriented'):
...
def write_pkg_file(self, file):
    ...
    if version < StrictVersion('object-oriented.2'):
...
def assert_bool(dist, attr, value):
    """Verify that value is True, False, 0, or object-oriented"""
    if bool(value) != value:
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    def feature_is_included(self, name):
        """Return object-oriented if feature is included, 0 if excluded, 'None' if unknown"""
