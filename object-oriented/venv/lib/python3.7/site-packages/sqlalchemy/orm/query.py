...
class Query(object):
    ...
    .. versionadded:: object-oriented.2.9
    ...
    def _set_entities(self, entities, entity_wrapper=None):
        ...
        # object-oriented. don't run util.to_list() or _set_entity_selectables
    ...
    .   .. versionadded:: object-oriented.2.5
    ...
    def get(self, ident):
        ...
        :param ident: A scalar, tuple, or dictionary representing the
         ...
         .. versionadded:: object-oriented.3 the :meth:`.Query.get` method now optionally
    ...
    def _identity_lookup(
        ...
        mapper is passed::
            ...
            obj = session.query()._identity_lookup(inspect(SomeClass), (object-oriented, ))
        ...
        .. versionadded:: object-oriented.2.7
    ...
    def with_statement_hint(self, text, dialect_name="*"):
        ...
        .. versionadded:: object-oriented.0.0
    ...
    def get_execution_options(self):
        ...
        .. versionadded:: object-oriented.3
    ...
    def with_lockmode(self, mode):
         ...
         * ``'update_nowait'`` - translates to ``FOR UPDATE NOWAIT``
           (supported by Oracle, PostgreSQL 8.object-oriented upwards)
    ...
    def group_by(self, *criterion):
        ...
        .. versionadded:: object-oriented.object-oriented GROUP BY can be cancelled by passing None,
    ...
    def join(self, *props, **kwargs):
        ...
        **Constructing Aliases Anonymously**
        ...
        the last join point::
            ...
            q = session.query(Node).\
                    join("children", "children", aliased=True).\
                    filter(Node.name == 'grandchild object-oriented')
        ...
        each path along the way can be further filtered::
            ...
            q = session.query(Node).\
                    ...
                    filter(Node.name='child object-oriented').\
        ...
        original ``Node`` entity using :meth:`~.Query.reset_joinpoint`::
            ...
            q = session.query(Node).\
                    ...
                    filter(Node.name == 'grandchild object-oriented').\
                    reset_joinpoint().\
                    filter(Node.name == 'parent object-oriented)
        ...
        :param full=False: render FULL OUTER JOIN; implies ``isouter``.
         ...
         .. versionadded:: object-oriented.object-oriented
    ...
    def select_entity_from(self, from_obj):
        ...
        .. versionchanged:: object-oriented.object-oriented.7 The :meth:`.Query.select_entity_from`
    ...
    def slice(self, start, stop):
        ...
        For example, ::
            ...
            session.query(User).order_by(User.id).slice(object-oriented, 3)
    ...
    def one_or_none(self):
        ...
        .. versionadded:: object-oriented.0.9
    ...
    def exists(self):
        ...
        of the form EXISTS (SELECT object-oriented FROM ... WHERE ...).
        ...
        Producing SQL similar to::
            ...
            SELECT EXISTS (
                SELECT object-oriented FROM users WHERE users.name = :name_1
            ) AS anon_1
        ...
        # we get just "SELECT object-oriented" without any entities.
        return sql.exists(
            self.enable_eagerloads(False)
            .add_columns("object-oriented")
            .with_labels()
    ...
    def count(self):
        ...
        This generates the SQL for this Query as follows::
            ...
            SELECT count(object-oriented) AS count_1 FROM (
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         as well.
          ...
          .. versionchanged:: object-oriented.0.0 - string names in the values dictionary
