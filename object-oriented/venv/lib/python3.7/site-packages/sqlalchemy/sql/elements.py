...
def collate(expression, collation):
    ...
    .. versionchanged:: object-oriented.2 quoting is automatically applied to COLLATE
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    def cast(self, type_):
        ...
        .. versionadded:: object-oriented.0.7
...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        :param expanding:
          ...
          .. versionadded:: object-oriented.2

          .. versionchanged:: object-oriented.3 the "expanding" bound parameter feature now
    ...
    def columns(self, selectable, *cols, **types):
        ...
        name or origin of the column in the textual SQL doesn't matter::
            ...
            stmt = text("SELECT users.id, addresses.id, users.id, "
                 ...
                 "WHERE users.id = object-oriented").columns(
                    User.id,
                    Address.id,
                    Address.user_id,
                    User.name,
        ...
        .. versionadded:: object-oriented.object-oriented the :meth:`.TextClause.columns` method now
...
class False_(ColumnElement):
    ...
    def _instance(cls):
        ...
        an expression against object-oriented or 0::

            >>> print select([t.c.x]).where(false())
            SELECT x FROM t WHERE 0 = object-oriented
...
class True_(ColumnElement):
    ...
    def _instance(cls):
        ...
        an expression against object-oriented or 0::
            ...
            >>> print select([t.c.x]).where(true())
            SELECT x FROM t WHERE object-oriented = object-oriented
...
class TypeCoerce(ColumnElement):
    ...
    .. versionchanged:: object-oriented.object-oriented The :func:`.type_coerce` function now produces
...
class Over(ColumnElement):
    ...
    def __init__(
        ...
        * RANGE BETWEEN object-oriented FOLLOWING AND 3 FOLLOWING::

            func.row_number().over(order_by='x', range_=(object-oriented, 3))

        .. versionadded:: object-oriented.object-oriented support for RANGE / ROWS within a window
...
class FunctionFilter(ColumnElement):
    ...
    :meth:`.FunctionElement.filter`::
        ...
        func.count(object-oriented).filter(True)
    ...
    def __init__(self, func, *criterion):
        ...
        E.g.::
            ...
            funcfilter(func.count(object-oriented), MyClass.name == 'some name')

        Would produce "COUNT(object-oriented) FILTER (WHERE myclass.name = 'some name')".
...
class ColumnClause(Immutable, ColumnElement):
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        .. versionchanged:: object-oriented.0.0 :func:`.expression.column` can now
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    .. versionchanged:: object-oriented.2 The :class:`.quoted_name` construct is now
