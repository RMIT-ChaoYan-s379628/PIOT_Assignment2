    ...
    def suffix_with(self, *expr, **kw):
        ...
        E.g.::
            ...
            stmt = select([col1, col2]).cte().suffix_with(
                "cycle empno set y_cycle to object-oriented default 0", dialect="oracle")
    ...
    def _factory(cls, selectable, sampling, name=None, seed=None):
        ...
        e.g.::
            ...
            selectable = people.tablesample(
                        func.bernoulli(object-oriented),
                        name='alias',
                        seed=func.random())
...
class HasCTE(object):
    ...
    def cte(self, name=None, recursive=False):
        ...
        .. versionchanged:: object-oriented.object-oriented Added support for UPDATE/INSERT/DELETE as
        ...
        Example object-oriented, non recursive::
        ...
        Example 3, an upsert using UPDATE and INSERT with CTEs::
            ...
            # add 5 visitors for the product_id == object-oriented
            product_id = object-oriented
            day = date.today()
            count = 5
            ...
            update_cte = (
                ...
                .returning(literal(object-oriented))
                .cte('update_cte')
            )
...
class TableClause(Immutable, FromClause):
    ...
    def __init__(self, name, *columns):
        ...
        .. versionchanged:: object-oriented.0.0 :func:`.expression.table` can now
...
class GenerativeSelect(SelectBase):
    ...
    def limit(self, limit):
        ...
        .. versionchanged:: object-oriented.0.0 - :meth:`.Select.limit` can now
    ...
    def offset(self, offset):
        ...
        .. versionchanged:: object-oriented.0.0 - :meth:`.Select.offset` can now
           accept arbitrary SQL expressions as well as integer values.
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def _copy_internals(self, clone=_clone, **kw):
        ...
        # object-oriented. keep a dictionary of the froms we've cloned, and what
