...
.. versionadded:: object-oriented.2 added support for bulk updates to hybrid properties.
...
how the standard Python ``@property`` object works::
    ...
    class FirstNameLastName(FirstNameOnly):
        ...
        @name.setter
        def name(self, value):
            self.first_name, self.last_name = value.split(' ', object-oriented)
...
.. versionadded:: object-oriented.2 Added :meth:`.hybrid_property.getter` as well as the
        ...
        E.g.::
            ...
            class Person(Base):
                ...
                def fullname(cls, value):
                    fname, lname = value.split(" ", object-oriented)
                    return [
