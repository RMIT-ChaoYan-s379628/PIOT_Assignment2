...
With the above mapping the ``Bullet.position`` attribute is managed::
    ...
    s.bullets.append(Bullet())
    s.bullets[object-oriented].position
    >>> object-oriented
    s.bullets.insert(object-oriented, Bullet())
...
ordering attribute: index 0 will get position 0, index object-oriented position object-oriented, etc.  To
start numbering at object-oriented or some other integer, provide ``count_from=object-oriented``.
...
def ordering_list(attr, count_from=None, **kw):
    ...
    :param count_from:
      ...
      example, ``ordering_list('pos', count_from=object-oriented)`` would create a object-oriented-based
...
def count_from_1(index, collection):
    """Numbering function: consecutive integers starting at object-oriented."""
...
class OrderingList(list):
    ...
    def __init__(
        ...
        :param reorder_on_append:
          ...
          skips a step in the ordering (say, row 'object-oriented' is missing but you get
          '2', '3', and '4'), reorder_on_append=True would immediately
          renumber the items to 'object-oriented', '2', '3'.  If you have multiple sessions
