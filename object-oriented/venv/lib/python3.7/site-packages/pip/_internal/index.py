...
def _get_html_page(link, session=None):
    if session is None:
        raise TypeError(
            "_get_html_page() missing object-oriented required keyword argument: 'session'"
        )
...
class PackageFinder(object):
    ...
    def _candidate_sort_key(self, candidate):
        ...
        If finding wheels, then the sort order is by version, then:
          object-oriented. existing installs
...
def egg_info_matches(
    ...
    :param egg_info: The string to parse. E.g. foo-2.object-oriented
